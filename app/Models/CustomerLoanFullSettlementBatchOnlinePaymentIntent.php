...
final class CustomerLoanFullSettlementBatchOnlinePaymentIntent extends Model
{
    ...
    protected $table = 'customer_loan_full_settlement_batch_online_payment_intents';
