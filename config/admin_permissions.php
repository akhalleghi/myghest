        ...
        [
            ...
            'children' => [
                ...
                [
                    ...
                    'children' => [
                        ['key' => 'customers.loans.create', 'label' => 'افزودن پرونده وام', 'routes' => ['admin.customers.loan-files.store']],
                        ...
                        [
                            ...
                            'children' => [
                                ...
                                ['key' => 'customers.loans.guarantees.create', 'label' => 'افزودن ضمانت', 'routes' => ['admin.customers.loan-files.guarantees.store', 'admin.guarantor-otp.send', 'admin.guarantor-otp.verify']],
                                ['key' => 'customers.loans.guarantees.update', 'label' => 'ویرایش ضمانت', 'routes' => ['admin.customers.loan-files.guarantees.update']],
